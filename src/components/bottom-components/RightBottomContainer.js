...
export default function RightBottomContainer(){
    ...
    const goodRating = <Box sx={{ display: 'flex', flexDirection: 'column', bgcolor: green[50]}}>
            <CardContent sx={{ flex: '1 0 auto' }}>
                <IconButton aria-label="play/pause">
                    <SentimentVerySatisfiedIcon sx={{ height: ratingIconDimension, width: ratingIconDimension }} />
                </IconButton>
            </CardContent>
        </Box>
    const neutralRating = <Box sx={{ display: 'flex', flexDirection: 'column', bgcolor: yellow[50]}}>
            <CardContent sx={{ flex: '1 0 auto' }}>
                <IconButton aria-label="play/pause">
                    <SentimentNeutralIcon sx={{ height: ratingIconDimension, width: ratingIconDimension }} />
                </IconButton>
            </CardContent>
        </Box>
    const badRating = <Box sx={{ display: 'flex', flexDirection: 'column', bgcolor: red[50]}}>
            <CardContent sx={{ flex: '1 0 auto' }}>
                <IconButton aria-label="play/pause">
                    <SentimentVeryDissatisfiedIcon sx={{ height: ratingIconDimension, width: ratingIconDimension }} />
                </IconButton>
            </CardContent>
        </Box>
    ...
    return <div className={'results'}>
        {directions.map((direction) => (
            ...
            <Card variant={"outlined"} sx={{display: 'flex', m:1}} key={direction.distance}>
                <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                    <CardContent sx={{ flex: '1 0 auto' }}>
                        <Typography component="div" variant="">
                            <IconButton aria-label="elevation">
                                <HeightIcon sx={{ height: iconDimension, width: iconDimension }} />
                            </IconButton>
                            Total elevation: {(direction.distance*1.5).toFixed(0)} meters
                        </Typography>
                        <Typography component="div" variant="">
                            <IconButton aria-label="distance">
                                <StraightenIcon sx={{ height: iconDimension, width: iconDimension }} />
                            </IconButton>
                            Distance: {direction.distance} kilometers
                        </Typography>
                        <Typography component="div" variant="">
                            <IconButton aria-label="duration">
                                <TimerIcon sx={{ height: iconDimension, width: iconDimension }} />
                            </IconButton>
                    ...
                    <CardContent sx={{ flex: '1 0 auto' }}>
                        <Typography component="div" variant="">
                            <IconButton aria-label="max-incline">
                                <CallMadeIcon sx={{ height: iconDimension, width: iconDimension }} />
                            </IconButton>
                            Maximum incline: {(Math.random()*15).toFixed(0)} degrees
                        </Typography>
                        <Typography component="div" variant="">
                            <IconButton aria-label="start" style={{color: green[500]}}>
                                <FlagIcon sx={{ height: iconDimension, width: iconDimension }} />
                            </IconButton>
